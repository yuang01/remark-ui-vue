        ...
        <div class="col-md-12">
          <div class="panel" :class="{ 'is-loading': fetchLoading }">
            <div class="panel-body">
              <Table :arr="defectRecalls" :currentPage="pagination.currentPage" :columns="columns"></Table>
...
<script>
import { getDefectRecalls } from '@/api/ciq';
...
export default {
  ...
  methods: {
    ...
    async url(currentPage) {
      ...
      const result = await getDefectRecalls({
        page: currentPage,
      ...
      this.defectRecalls.splice(0, this.defectRecalls.length);
      this.defectRecalls = result.data.list;
