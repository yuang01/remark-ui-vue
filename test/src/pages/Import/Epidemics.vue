        ...
        <div class="col-md-12">
          <div class="panel" :class="{ 'is-loading': fetchLoading }">
            <div class="panel-body">
              <Table :arr="epidemics" :currentPage="pagination.currentPage" :columns="columns"></Table>
...
<script>
import { getEpidemics } from '@/api/ciq';
...
export default {
  ...
  methods: {
    ...
    async url(currentPage) {
      ...
      const result = await getEpidemics({
        page: currentPage,
      ...
      this.epidemics.splice(0, this.epidemics.length);
      this.epidemics = result.data.list;
