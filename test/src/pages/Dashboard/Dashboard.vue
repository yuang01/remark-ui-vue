    ...
    <div class="page-content" slot="content">
      <div class="row">
        <div class="col-md-3">
          <div class="panel">
            <div class="panel-heading">
              <h4 class="panel-title">进口风险信息变化趋势</h4>
            </div>
            <div class="panel-body">
              <div id="line1" style="height: 230px;">
              </div>
            </div>
          </div>
          <div class="panel">
            <div class="panel-heading">
              <h4 class="panel-title">进口风险国家统计</h4>
            </div>
            <div class="panel-body">
          ...
          <div class="panel">
            <div class="panel-heading">
              <h4 class="panel-title">进口风险信息统计</h4>
            </div>
            <div class="panel-body">
              <div id="pie1" style="height: 230px;">
              </div>
            </div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="panel">
            <div class="panel-heading">
              <h4 class="panel-title">系统概览</h4>
            </div>
            <div class="panel-body">
              <div class="risk-overview" style="height: 230px;">
                <table>
                  <tr>
                    <th>监测风险信息总数</th>
                    <th>监测品牌总数</th>
          ...
          <div class="panel">
            <div class="panel-heading">
              <h4 class="panel-title">全球概览</h4>
            </div>
            <div class="panel-body">
              <div id="map1" style="height: 530px;">
              </div>
            </div>
          </div>
        </div>
        <div class="col-md-3">
          <div class="panel">
            <div class="panel-heading">
              <h4 class="panel-title">出口风险信息统计</h4>
            </div>
            <div class="panel-body">
              <div id="pie4" style="height: 230px;">
              </div>
            </div>
          </div>
          <div class="panel">
            <div class="panel-heading">
              <h4 class="panel-title">出口风险信息类别</h4>
            </div>
            <div class="panel-body">
          ...
          <div class="panel">
            <div class="panel-heading">
              <h4 class="panel-title">出口风险信息变化趋势</h4>
            </div>
            <div class="panel-body">
              <div id="line2" style="height: 230px;">
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    async url() {
      ...
      this._vue_charts = echarts.init(document.getElementById('line1'), 'walden');
      ...
      this._vue_charts = echarts.init(document.getElementById('pie1'), 'walden');
      this._vue_charts.setOption(this.pie1);
      this._vue_charts = echarts.init(document.getElementById('map1'), 'walden');
      this._vue_charts.setOption(this.map1);
      this._vue_charts = echarts.init(document.getElementById('pie4'), 'walden');
      ...
      this._vue_charts = echarts.init(document.getElementById('line2'), 'walden');
